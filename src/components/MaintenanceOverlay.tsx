...
export default function MaintenanceOverlay() {
  return (
    <div className="fixed inset-0 z-[9999] flex min-h-screen flex-col items-center justify-center gap-8 bg-bg px-6 py-12 text-center overflow-y-auto">
      <img src="/logo.svg" alt="Advertising Club Trivandrum" className="h-10 w-auto sm:h-12 shrink-0" />
